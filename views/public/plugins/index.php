            ...
            <div class="col-12">
                <table class="table table-striped">
                    ...
                    foreach ($data['plugins'] as $plugin) {
                       ...
                       echo "<button type='submit' class='btn btn-sm btn-warning' name='" . $name_activer . "' value='" . $plugin['directory'] . "'>";
                       ...
                       echo "<button type='submit' class='btn btn-sm btn-warning' name='" . $name_installer . "' value='" . $plugin['directory'] . "'>";
