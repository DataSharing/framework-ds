<?php
/**
 * Class Check : Vérification au lancement de l'application pour l'installation de celle-ci
 */
Class Check {
    /*
     * Si dossier installation existe
     * Vérification des dossiers manquant & des droits d'écriture sur le répertoire
     */
    public static function __run(){
        ...
        if(Check::FileConfig() == 1 || Check::FileDatabase() == 1){
            ...
            echo "<i>-- V�rifier les droits d'�criture sur le repertoire</i><br>";
            echo "<i>-- Renommer ou copier le dossier d'installation �la racine du site et relancer l'installation en rafraichissant la page...</i><br>";
            exit;
        }	
    }
