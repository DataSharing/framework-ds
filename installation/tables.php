	...
	public static function creation($db, $prefixe)
	{
		...
		$tables[3] = "CREATE TABLE IF NOT EXISTS `" . $prefixe . "logs` (
			`id` int(11) NOT NULL AUTO_INCREMENT,
			  ...
			  `id_description` INT(11) NULL DEFAULT NULL,
			  PRIMARY KEY (`id`))";
		...
		//Création de la table plugin 
		$tables[5] = "CREATE TABLE IF NOT EXISTS `" . $prefixe . "plugins` (
			`id` INT(11) NOT NULL AUTO_INCREMENT,
		...
		//Création de la table logs_description 
		$tables[6] = "CREATE TABLE IF NOT EXISTS `" . $prefixe . "logs_description` (
			`id` INT(11) NOT NULL AUTO_INCREMENT,
			`old` LONGTEXT NULL DEFAULT NULL COLLATE 'utf8_general_ci',
			`new` LONGTEXT NULL DEFAULT NULL COLLATE 'utf8_general_ci',
			`diff` LONGTEXT NULL DEFAULT NULL COLLATE 'utf8_general_ci',
			PRIMARY KEY (`id`) USING BTREE
		)
